...
use winapi::um::winnt::{
    ...
    PACL, PSECURITY_DESCRIPTOR, PROTECTED_DACL_SECURITY_INFORMATION, PSID, PTOKEN_PRIVILEGES, SACL_SECURITY_INFORMATION,
    SE_PRIVILEGE_ENABLED, TOKEN_ADJUST_PRIVILEGES, TOKEN_PRIVILEGES, TOKEN_QUERY, SID_NAME_USE
};
